...
public class GerenciadorTarefasTest {
    ...
    * Arthur - revisão 06/03/2024*/
    ...
    public void testAtualizacaoTituloTarefaNaoCriada() {        
        Boolean status = gerenciadorTarefas.atualizarTituloTarefa("usuario1", "Tarefa 2", "1");
        assertFalse(status);
    }
    ...
    public void testAtualizacaoDescricaoTarefaNaoCriada() {        
        Boolean status = gerenciadorTarefas.atualizarDescricaoTarefa("usuario1", "Tarefa 2", "Testando");
        assertFalse(status);
    }
    ...
    public void testAtualizacaoDataVencimentoTarefaNaoCriada() {
        Boolean status = gerenciadorTarefas.atualizarDataVencimento( "usuario1", "Tarefa 2", "03/03/2024");
        assertFalse(status);
    }
    ...
    public void testAtualizacaoPrioridadeTarefaNaoCriada() {
        Boolean status = gerenciadorTarefas.atualizarPrioridade("usuario1", "Tarefa 2", "alta");
        assertFalse(status);
    }
    ...
    public void testExclusaoTarefaNaoCriada() {
        Boolean status = gerenciadorTarefas.excluirTarefa("usuario1", "Tarefa 2");
        assertFalse(status);
    }
